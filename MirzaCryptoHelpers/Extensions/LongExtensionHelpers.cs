...
namespace MirzaCryptoHelpers.Extensions
{
    ...
    public static class LongExtensionHelpers
    {
        ...
        /// <summary>
        /// Get SHA1 hash from current long in Base64 encoded string format. Returns null if fails.
        /// </summary>
        /// <param name="value">long value.</param>
        ...
        /// <summary>
        /// Get SHA256 hash from current long in Base64 encoded string format. Returns null if fails.
        /// </summary>
        /// <param name="value">long value.</param>
        ...
        /// <summary>
        /// Get SHA384 hash from current long in Base64 encoded string format. Returns null if fails.
        /// </summary>
        /// <param name="value">long value.</param>
        ...
        /// <summary>
        /// Get SHA512 hash from current long in Base64 encoded string format. Returns null if fails.
        /// </summary>
        /// <param name="value">long value.</param>
